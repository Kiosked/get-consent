...
| [type] | <code>String</code> | Type of consent data to fetch. Defaults to ""  (generic CMP consent data). Can be set to "google" for Google consent  data or "vendor" for vendors consent data. |
